...
def set_routes(app):
    app.add_url_rule("/zonas_inundables/<int:page>",
                     "flood_zone_index", flood_zone.index, methods=['POST', 'GET'])
    ...
    app.add_url_rule("/zonas_inundables/editar/<int:id>",
                     "flood_zone_edit", flood_zone.edit, methods=['POST', 'GET'])
    app.add_url_rule("/zonas_inundables/mod",
                     "flood_zone_modify", flood_zone.modify, methods=['POST', 'GET'])
    ...
    app.add_url_rule("/zonas_inundables/importar", "flood_zone_imported_zones",
                     flood_zone.importedZones, methods=['POST', 'GET'])   
